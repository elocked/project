...
import com.example.kzx2000.e_lock.app.AppConfig;
import com.example.kzx2000.e_lock.app.AppController;
...
public class LoginActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        btnLinkToNFC = (Button) findViewById(R.id.btnLinkToNFC);
        ...
        btnLinkToNFC.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(view.getContext(), LockActivity.class);
                startActivity(i);
            }
        });
